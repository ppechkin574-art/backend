...
from api.routes.payments.apple_s2s import router as apple_s2s_router
...
routers = [payment_router, payment_webhook_router, payment_ws_router, apple_iap_router, android_iap_router, apple_s2s_router]
